...
public abstract class Conta {
    ...
    public void imprimirExtratoTaxas() {
        ...
        if (this instanceof ITaxas) {
            double taxaManutencao = ((ITaxas) this).calculaTaxas();
        ...
        for (Operacao op : this.operacoes) {
            if (op != null && op instanceof ITaxas) {
                double taxaOperacao = ((ITaxas) op).calculaTaxas();
                if (taxaOperacao > 0) {
                    System.out.println(op.getTipo() + ": " + taxaOperacao);
